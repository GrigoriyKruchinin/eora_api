...
class Settings:
    ...
    LLM_CONTEXT = (
        ...
        "В своих ответах учитывай только данные, которые относятся к сути вопроса. "
        "Пожалуйста, предоставляй не более 1-5 примеров в ответе, чтобы избежать избыточной информации. "
        "Вот некоторые данные, которые могут помочь в ответе:\n"
    )
